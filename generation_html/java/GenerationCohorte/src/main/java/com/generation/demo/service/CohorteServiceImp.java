...
public class CohorteServiceImp implements CohorteService{
	...
	CohorteRepository cohorteRepository;//relacion con repositorio
//	CohorteService cohorteService= new CoohorteServiceImp();
	...
	@Override
	public List<Cohorte> getCohorteByCiudad(String ciudad) {
